...
const quiz = {
  ...
  possibleAnswers: {
    ...
    7: ["0", "инструмент"],
    8: ["0", "pulse up", "pulse", "pulseup", "пульс ап", "пульс", "пульсап"],
    9: ["0", "том уэйтс", "том вэйтс", "том уейтс", "том", "уэйтс", "вэйтс", "уейтс", "tom waits", "tom", "waits"],
    10: ["0", "усик маркосян", "усик", "маркосян"],
    11: ["0", "наполеон", "динамит", "наполеон динамит", "napoleon", "dynamite", "napoleon dynamite"],
    12: ["0", "веда", "veda"],
    13: ["0", "ляо"],
  },
  correctAnswers: {
